              ...
              <div class="col-lg-12">
                <div class="blog-post">
                  <div class="blog-thumb">
                    <img src="{{asset('assets/images/blog-posts-images/' . $blog->image)}}" alt="">
                  </div>
                  <div class="down-content">
                    ...
                    <p>You can browse different tags such as <a rel="nofollow"
                      ...
                      <a rel="nofollow" href="https://templatemo.com/tag/video" target="_parent">video</a>, etc. to see
                      more CSS templates. Sed hendrerit rutrum arcu, non malesuada nisi. Sed id facilisis turpis. Donec
                      justo elit, dapibus vel ultricies in, molestie sit amet risus. In nunc augue, rhoncus sed libero
                      et, tincidunt tempor nisl. Donec egestas, quam eu rutrum ultrices, sapien ante posuere nisl, ac
                    ...
                    <div class="post-options">
                      ...
                      <div class="d-block my-4">
                        <a class="btn btn-outline-primary w-25" href="{{route('blog.edit', $blog->id)}}">Edit</a>
                      </div>
                      <div class="d-block my-4">
