  ...
  <section class="call-to-action">
    <div class="container">
      ...
      <div class="create-post">
        <a class="btn btn-outline-primary my-4" href="{{route('blog.create')}}">Create Post</a>
      </div>
    </div>
  </section>
                  ...
                  <div class="blog-post">
                    <div class="blog-thumb">
                      <a href="{{route('blog.show', $blog->id)}}">
                        <img
                          src="{{asset('assets/images/blog-posts-images/' . $blog->image)}}"
                          alt="blog-image">
                      </a>
                    </div>
                    <div class="down-content">
                      <span>Lifestyle</span>
                      <a href="{{route('blog.show', $blog->id)}}"><h4>{{$blog->title}}</h4></a>
                      <ul class="post-info">
